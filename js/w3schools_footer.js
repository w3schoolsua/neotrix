...
function printPage() {
    ...
    myWindow.document.write("<html><head>"+head+"<style>body{padding:15px;}@media print {.printbtn {display:none;}}</style></head><body><button class='printbtn' onclick='window.print()'>Ð”Ñ€ÑƒÐº ÑÑ‚Ð¾Ñ€Ñ–Ð½ÐºÐ¸</button><br><br>"+content+"<p><a href='../about/about_copyright.html'>Copyright 1999-2025</a> by Refsnes Data. All Rights Reserved.</p></body></html>");
}
(
